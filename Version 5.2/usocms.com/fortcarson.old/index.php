...
if ($maintenance=="true")
{
    ...
    echo "We are upgrading the USO CMS software. The Site will be back up 6am December 7, 2011";
    exit();
}
else
{
    ...
    else  //If ?page= var not empty
    {
        ...
        { 
            ...
            header("Location: https://$host$uri/$dir"); //redirect user to proper page.
            exit();
         }
    ...
    if (!empty($_GET['page']))
    {
        ...
        //unset($pages[0], $pages[1], $pages[3], $pages[4], $pages[6], $pages[8], $pages[9], $pages[10], $pages[11], $pages[12], $pages[13], $pages[14], $pages[17], $pages[19], $pages[21], $pages[22], $pages[23], $pages[24], $pages[25]);
