...
?>
        <tr>
         ...
         <td align="center"><input class="content2" name="day[]" type="text" id="day" value="<? echo $rows['day']; ?>" disabled></td>
         <td align="center"><input class="content" name="lunch[]" type="text" id="lunch" value="<? echo $rows['lunch']; ?>"></td>
         <td align="center"><input class="content" name="dinner[]" type="text" id="dinner" value="<? echo $rows['dinner']; ?>"></td>
        </tr>
<?php 
}
?>
   ...
   <?PHP
echo '<p style="font-size:12px;text-align:center;"> Version:  &copy;2010-2011 <a style="text-decoration:none;" href="http://3xsecurityservices.com">3X Security, LLC</a><br /><a style="text-decoration:none;" href="/ul">*</a> <a href="/index.php?page=menu">Food Menu</a> | <a href="/index.php?page=directions">Directions</a> | Activities | Hours of Operation | Contact Us <a style="text-decoration:none;" href="/ul">*</a> ';
?>
  </div>
 </body>
<?php
...
if($Submit){
for($i=0;$i<$count;$i++){
$sql1="UPDATE $tbl_name SET day='$day[$i]', lunch='$lunch[$i]', dinner='$dinner[$i]' WHERE id='$id[$i]'";
