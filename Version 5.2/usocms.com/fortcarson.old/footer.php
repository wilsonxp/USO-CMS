...
if (isset ($_SESSION['username']))
{
    ...
    $uri   = rtrim(dirname($_SERVER['PHP_SELF']), '/\\');
        ...
        {
            $links="<a href='../index.php?page=menu'>Food Menu</a> | <a href='../index.php?page=directions'>Directions</a> | <a href='../index.php?page=activities'>Activities</a> | <a href='../index.php?page=ophours'>Hours of Operation</a> | <a href='index.php?page=feedback'>Contact Us</a> | <a href='index.php?page=privacy'>Privacy</a> | <a href='../index.php?dir=ul'>Admin Pannel</a> | <a href='members.php?cmd=logout'>Logout</a>";   
        }
        else
        {
            $links="<a href='index.php?page=menu'>Food Menu</a> | <a href='index.php?page=directions'>Directions</a> | <a href='index.php?page=activities'>Activities</a> | <a href='index.php?page=ophours'>Hours of Operation</a> | <a href='index.php?page=feedback'>Contact Us</a>  | <a href='index.php?page=privacy'>Privacy</a> | <a href='index.php?dir=ul'>Admin Pannel</a> | <a href='index.php?cmd=logout'>Logout</a>";
        }
}
else
{
