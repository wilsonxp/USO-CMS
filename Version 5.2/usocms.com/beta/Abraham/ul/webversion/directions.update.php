...
if($Submit){
for($i=0;$i<$count;$i++){
$sql1="UPDATE uso_directions SET gate='$gate[$i]', directions='$directions[$i]', updated='$updated[$i]' WHERE id='$id[$i]'";
...
mysql_close();
    ...
    echo ' &copy;2010-2011 <a style="text-decoration:none;" href="http://facebook.com/christopher.sparrowgrove">Sparrowgrove, Christopher</a>';
    //include ('footer.php');
    ?>   
</div>
</body>
