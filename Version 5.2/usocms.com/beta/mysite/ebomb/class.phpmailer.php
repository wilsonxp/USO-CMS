...
class PHPMailer {
   ...
   * @var bool
   */
  public $SMTPAuth      = false; //Default: False

  /**
   * Sets SMTP username.
   * @var string
   */
  public $Username      = 'admin@3xsecurityservices.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'delilahbenjaminconcolino2010';
 ...
 /**
   ...
   * @var string
   */
  public $XMailer         = 'USO CMS Feedback Form';
