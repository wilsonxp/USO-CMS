...
<html>
    <head>
        ...
        <style type="text/css">
            .ul {color:black; text-decoration: none; border:none;}
            ins {font-size: 1.2em; text-decoration: none; border:none;}
        </style>
    </head>
...
<p class="select_footer">
            Version: <?PHP echo $version; ?> <a href="http://beta.usocms.com/index.php?location=fortcarson&page=ul" class="ul"><ins>&copy;</ins></a>2010-2011 
