 ...
 * DESCRIPTION:  A menu for Operation Hours
...
<body>
    ...
    <div id="table">
        <div id="title" style="font-weight:900; font-size:20px; "> USO Fort Carson Operation Hours 
            <div class="fb-like" data-href="http://www.facebook.com/3Xsec" data-send="false" data-layout="button_count" 
    ...
    <table id="menu">
        ...
        <tr>
            ...
            <td id="td1" style="font-size:8.0pt;font-family:'Courier New'; text-align:center;">
                      <?PHP
                        $results = mysql_query('SELECT open FROM ophours');
                        if (!$results) 
                            {
            ...
            <td id="td1" style="font-size:8.0pt;font-family:'Courier New'; text-align:center;">
                      <?PHP
                        $results = mysql_query('SELECT close FROM ophours');
                        if (!$results) 
                            {
                            die('Bad Query: ' . mysql_error());
                            }
